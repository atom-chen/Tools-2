...
namespace Lua
{
    ...
    template<> struct TypeOf<lua_Integer>
    {
        ...
        static const LuaTypes::LuaType LuaType = LuaTypes::Integer;
        static const const char* TypeName = "Integer";
    };

    template<> struct TypeOf<lua_Number>
    {
        typedef lua_Number Type;
        static const LuaTypes::LuaType LuaType = LuaTypes::Number;
        static const const char* TypeName = "Number";
    };

    template<> struct TypeOf<lua_String>
    {
        typedef lua_String Type;
        static const LuaTypes::LuaType LuaType = LuaTypes::String;
        static const const char* TypeName = "String";
    };

    template<> struct TypeOf<lua_LightUserData>
    {
        typedef lua_LightUserData Type;
        static const LuaTypes::LuaType LuaType = LuaTypes::UserData;
        static const const char* TypeName = "UserData";
    };

    template<> struct TypeOf<bool>
    {
        typedef bool Type;
        static const LuaTypes::LuaType LuaType = LuaTypes::Bool;
        static const const char* TypeName = "Bool";
    };
