...
#else
		bool createOgreSubmesh(Ogre::v1::MeshPtr pMesh,const ParamList& params);
#endif
...
#else
		bool createOgreVertexBuffer(Ogre::v1::SubMesh* pSubmesh, Ogre::v1::VertexDeclaration* pDecl, const std::vector<vertex>& vertices);
#endif
