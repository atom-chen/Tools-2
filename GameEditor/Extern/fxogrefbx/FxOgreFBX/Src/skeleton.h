...
#else
		bool loadOgreSkeletonFromFile(OgreManagers& managers, std::string &skeletonFilePath, Ogre::v1::Skeleton& skel);
#endif
...
#else
		bool replaceAnimation(Ogre::v1::Skeleton& skeleton, const std::string& clipName, float start, float stop, float rate, ParamList& params);
#endif
...
#else
		bool createOgreBones(Ogre::v1::Skeleton& skeleton, ParamList& params);
#endif
        // write skeleton animations to an Ogre skeleton
#if OGRE_VERSION < 0x020000
        bool createOgreSkeletonAnimations(Ogre::Skeleton& skeleton,ParamList& params);
#else
		bool createOgreSkeletonAnimations(Ogre::v1::Skeleton& skeleton, ParamList& params);
#endif
...
#else
		bool addOgreSkeletonAnimation(Ogre::v1::Skeleton& skeleton, Animation& anim);
#endif
