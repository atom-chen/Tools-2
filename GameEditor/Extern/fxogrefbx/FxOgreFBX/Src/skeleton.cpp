...
#else
		Ogre::v1::Skeleton skel = Ogre::v1::Skeleton(0, "fbxexport_skeleton", 0, Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME);		// TODO: E:\Self\Self\Tools\Tools\GameEditor\Extern\ogre\OgreMain\src\Animation\OgreSkeletonManager.cpp
#endif
...
#else
	bool Skeleton::loadOgreSkeletonFromFile(OgreManagers& managers, std::string &skeletonFilePath, Ogre::v1::Skeleton& skel)
#endif
    {
...
#else
		Ogre::v1::Skeleton::BoneIterator iterator = skel.getBoneIterator();
#endif
        int id = 0;
...
#else
	bool Skeleton::replaceAnimation(Ogre::v1::Skeleton& skeleton, const std::string& clipName, float start, float stop, float rate, ParamList& params)
#endif
    {
        Animation a;
...
#else
	bool Skeleton::createOgreBones(Ogre::v1::Skeleton& skeleton, ParamList& params)
#endif
    {
        size_t i;
        // Create the bones
...
#else
	bool Skeleton::addOgreSkeletonAnimation(Ogre::v1::Skeleton& skeleton, FxOgreFBX::Animation& anim)
#endif
    {
...
#else
		Ogre::v1::Animation* pAnimation = skeleton.createAnimation(anim.m_name.c_str(), anim.m_length);
#endif
...
#else
			Ogre::v1::NodeAnimationTrack* pTrack/* = pAnimation->createNodeTrack(skeleton.getBone(t->m_bone.c_str()))*/;	// TODO:
#endif
...
#else
	bool Skeleton::createOgreSkeletonAnimations(Ogre::v1::Skeleton& skeleton, ParamList& params)
#endif
    {
