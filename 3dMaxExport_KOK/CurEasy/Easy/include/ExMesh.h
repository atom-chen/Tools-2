...
namespace EasyOgreExporter
{
	...
	public:
		...
		void exportFaceXml(tinyxml2::XMLElement* facesElem, tinyxml2::XMLDocument* pXMLDocument);
	...
	public:
		...
		void exportGeometryXml(tinyxml2::XMLElement* vertexbufferElem, tinyxml2::XMLDocument* pXMLDocument);
		void exportTextureCoordXml(tinyxml2::XMLElement* vertexbufferElem, tinyxml2::XMLDocument* pXMLDocument);
		void exportVertexBoneAssignmentXml(tinyxml2::XMLElement* vertexboneassignmentElem, tinyxml2::XMLDocument* pXMLDocument);
	...
	public:
		...
		void export_Face_Geometry_BoneAssignments_Xml(tinyxml2::XMLElement* submeshesElem, tinyxml2::XMLDocument* pXMLDocument);
	};
