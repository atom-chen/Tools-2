...
class Md5DirOperate(object):
    def __init__(self):
        ...
        # 读取原始的目录配置文件
        bVerSrcExist = False
        if os.path.exists(Config.instance().preVerDirPath()):
            if os.path.isfile(Config.instance().preVerDirPath()):
                bVerSrcExist = True
        
        if bVerSrcExist:
            self.m_dirMd5Lst[EConst.ePreMd5Dir].initFromFile(Config.instance().preVerDirPath())
            
        self.m_dirMd5Lst[EConst.eCurMd5Dir].initFormDir(Config.instance().uiSrcRootPath())
        self.m_dirMd5Lst[EConst.eCurMd5Dir].initFormDir(Config.instance().externSrcRootPath())
        self.m_dirMd5Lst[EConst.eCurMd5Dir].initFormDir(Config.instance().coreSrcRootPath())
        self.m_dirMd5Lst[EConst.eCurMd5Dir].initFormDir(Config.instance().moduleSrcRootPath())
    ...
    def savaDirMd(self):
        self.m_dirMd5Lst[EConst.eCurMd5Dir].writeToFile(Config.instance().curVerDirPath())
