...
// 写入文件
void PakItemBase::writeFile2ArchiveFile(ArchiveParam* pArchiveParam)
{
...
void PakItemBase::readArchiveFileHeader(FILE* fileHandle)
{
...
void PakItemBase::writeArchiveFile2File(UnArchiveParam* pUnArchiveParam)
{
...
void PakItemBase::initByPakPathSplitInfo(PakPathSplitInfo* m_pPakPathSplitInfo, uint32 packIdx)
{
