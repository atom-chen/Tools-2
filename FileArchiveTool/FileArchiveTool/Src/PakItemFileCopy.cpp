...
void PakItemFileCopy::ArchiveDir()
{
...
void PakItemFileCopy::unArchiveFile()
{
...
void PakItemFileCopy::adjustHeaderOffset()
{
...
void PakItemFileCopy::calcHeaderSize(uint32& headerSize)
{
...
void PakItemFileCopy::clearFileVec()
{
	m_fileSize = 0;
...
void PakItemFileCopy::readArchiveFileHeader(const char* pFileName)
{
...
void PakItemFileCopy::readArchiveFileHeader(FILE* fileHandle)
{
...
void PakItemFileCopy::initByPakPathSplitInfo(PakPathSplitInfo* m_pPakPathSplitInfo, uint32 packIdx)
{
