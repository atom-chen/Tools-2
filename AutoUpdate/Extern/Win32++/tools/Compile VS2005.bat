...
devenv /build Debug DockMDI\ProjectFiles\DockMDIFrame_2005.sln                  >>"..\output\VS2005.log"
devenv /build Release DockMDI\ProjectFiles\DockMDIFrame_2005.sln                >>"..\output\VS2005.log"
