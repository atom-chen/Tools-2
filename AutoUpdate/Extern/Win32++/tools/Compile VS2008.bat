...
devenv /build Debug DockMDI\ProjectFiles\DockMDIFrame_2008.sln                >>"..\output\VS2008.log"
devenv /build Release DockMDI\ProjectFiles\DockMDIFrame_2008.sln              >>"..\output\VS2008.log"
